...
extern int omap4_cminst_wait_module_ready(u8 part, u16 inst, u16 cdoffs, u16 clkctrl_offs);
...
extern u32 omap4_cminst_rmw_inst_reg_bits(u32 mask, u32 bits, u8 part,
					   u16 inst, u16 idx);
extern u32 omap4_cminst_set_inst_reg_bits(u32 bits, u8 part, u16 inst,
					   u16 idx);
extern u32 omap4_cminst_clear_inst_reg_bits(u32 bits, u8 part, u16 inst,
					   u16 idx);
