...
static struct omap_mbox_dev_info am33xx_mbox_info[] = {
	{ .name = "wkup_m3", .tx_id = 0, .usr_id = 3 },
};

static struct omap_mbox_pdata am33xx_mbox_attrs = {
	.intr_type	= MBOX_INTR_CFG_TYPE2,
	.info_cnt	= ARRAY_SIZE(am33xx_mbox_info),
	.info		= am33xx_mbox_info,
};
